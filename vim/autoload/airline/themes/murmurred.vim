" Copyright Matt Seabold 2017
"
" My red-modified version of vim-airline-themes' murmer
" Changes from upstream:
"   Change s:cterm_alert to 167 (lighter red that is more visible)
"   Swap Replace and Normal colors (so normal mode matches tmux/LEDs)
"   Replace normal mode middle text with white

let g:airline#themes#murmurred#palette = {}
...
let s:cterm_normalbg  = 88   " Background for normal mode and file position blocks
...
let s:cterm_replacebg = 27   " Background for replace mode and file position blocks
...
let s:cterm_alert     = 167   " Modified file alert color
...
let s:N2 = [s:gui_termfg2, s:gui_termbg2, s:cterm_normalfg, s:cterm_termbg2]     " Middle block
let g:airline#themes#murmurred#palette.normal = airline#themes#generate_color_map(s:N1, s:BB, s:N2)
let g:airline#themes#murmurred#palette.normal_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmurred#palette.insert = airline#themes#generate_color_map(s:I1, s:BB, s:I2)
let g:airline#themes#murmurred#palette.insert_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmurred#palette.replace = airline#themes#generate_color_map(s:R1, s:BB, s:R2)
let g:airline#themes#murmurred#palette.replace_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmurred#palette.visual = airline#themes#generate_color_map(s:V1, s:BB, s:V2)
let g:airline#themes#murmurred#palette.visual_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmurred#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

" CtrlP plugin colors
if !get(g:, 'loaded_ctrlp', 0)
  finish
endif
let g:airline#themes#murmurred#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
